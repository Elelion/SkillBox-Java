...
public class DBConnection {
    ...
    public static void countVoter(String name, String birthDay) throws SQLException {
        ...
        if (!rs.next()) {
            System.out.println( "('" + name + "', '" + birthDay + "', 1)" );
        ...
        /**
         * если оставить БЕЗ закрывания, то произойдет учетчка памяти
         * и ResultSet будут копиться, копиться и копиться
         *
         * Важно - когда работаем с БД - всегда надо все закрывать
         */
        rs.close();
    }
