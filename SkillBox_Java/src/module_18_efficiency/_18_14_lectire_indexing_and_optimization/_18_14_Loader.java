...
public class _18_14_Loader {
    ...
    public static void _18_14_beginEvents() throws Exception {
        ...
        /**
         * данный цикл выдаст результат что то вроде
         * 8 - 1 - 0 - 0 - 1
         *
         * это будет из за того, что данные кешируются, и повторный результат
         * будет браться из кеша
         */
        for (int i = 0; i < 5; i++) {
            long startLocal = System.currentTimeMillis();

            DBConnection.customerSelect();

            System.out.println("Время выполнения: " +
                (System.currentTimeMillis() - startLocal) + " мс");
        }
        ...
        System.out.println("id: " + DBConnection.customerSelect());
