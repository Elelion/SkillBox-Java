package module_15_working_with_files_and_the_network._15_9_lecture_parsingJSON;
...
public class ParsingJSON {
    private static String DATA_FILE =
        System.getProperty("user.dir") + "/SkillBox_Java/lib/map.json";;
    ...
    public ParsingJSON() {
        /**
         * JSON может быть либо объектным либо массивным
         * {
         *      "key": 12,
         *      "id": [
         *          23, 42, 22
         ...
         * [12, 14, 15]
         *
         * либо может быть массив объектов
         * [
         *      {}
         *      {}
         * ],
    ...
    private static void createStationIndex() {
        ...
        try {
            ...
            // получаем string , который преобразуем в JSONObject
            JSONObject jsonData = (JSONObject) parser.parse(getJsonFile());

            /**
             * .get - получаем ключи, в JSON это массивы, по этому и тут мы
             * указываем (JSONArray)
             *
             * те в linesArray будет содержаться все, что
             * находиться в "lines": [...]
             */
    ...
    /**
     * добавляем распарсенный linesArray в stationIndex. где мы берем только
     * указанные ключи number и name
     */
    ...
    private static String getJsonFile() {
        ...
        try {
            // считываем весь файл, и записываем в виде строк все в lines
            List<String> lines = Files.readAllLines(Paths.get(DATA_FILE));

            /**
             * пробигаемся по каждой полученной строке, и последовательно
             * записываем все в builder те получиться так
             * {  "stations": {    "1": [      "Девяткино",      итп...
             */
        ...
        // возвращаем нашу строку где уже есть данные
