package module_13_features_of_OOP._13_14_practical_airport;
...
public class Airport {
    ...
    private void initializeAirport() {
        ...
        int aircraftsCount = 125 + (int)((Math.random() - 0.5) * 50.0);
    ...
    private Date generateRandomDate() {
        ...
        long randomTime = currentTime + (long)((this.random.nextDouble() - 0.5) * 2.0 * 8.64E7);
